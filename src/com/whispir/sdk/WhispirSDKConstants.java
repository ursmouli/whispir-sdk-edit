...
public final class WhispirSDKConstants {
	...
	// Filters
	public static final String LIMIT_EXT = "&limit=";
	public static final String OFFSET_EXT = "&offset=";
	public static final String FROM_DATE_EXT = "&criteriaFromDate=";
	public static final String FROM_TIME_EXT = "&criteriaFromTime=";
	public static final String TO_DATE_EXT = "&criteriaToDate=";
	public static final String TO_TIME_EXT = "&criteriaToTime=";
}
